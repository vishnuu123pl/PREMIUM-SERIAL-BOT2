...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://V:V@cluster0.ajetjrb.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DELETE_TIME = int(environ.get('DELETE_TIME', 5000))
